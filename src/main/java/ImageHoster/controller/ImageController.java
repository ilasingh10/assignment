...
public class ImageController {
    ...
    private final String EDIT_ERROR = "Only the owner of the image can edit the image";
    private final String DELETE_ERROR = "Only the owner of the image can delete the image";
